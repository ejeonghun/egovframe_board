<%--
  Class Name : EgovRegister.jsp
  Description : Register 화면
--%>
            ...
            <div id="content">
                ...
                <div id="content_img_div"><img  alt="LOGIN 표준프레임워크 경량환경 단순 홈페이지에 오신것을 환영합니다." src="<c:url value='/'/>images/subtitle/img_subtitle_login.gif" width="776" height="230" /></div>       
                    <div class="user_register">
                            <form:form name="registerForm" method="post" action="#LINK">
                            <div class="user_register_ultop">
                                ...
                                <input type="button" class="btn_style" onclick="javascript:actionLogin()" src="<c:url value='/'/>"  value="회원가입"/>
                            </div>
